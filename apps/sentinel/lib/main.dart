...
void main() async {
  ...
  try {
    ...
    await SupabaseClientWrapper.instance.initialize(
      supabaseUrl: 'YOUR_SUPABASE_URL', // TODO: Load from environment
      supabaseAnonKey: 'YOUR_SUPABASE_ANON_KEY', // TODO: Load from environment
      debugMode: true, // TODO: Load from environment
    );
