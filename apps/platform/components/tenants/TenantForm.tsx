            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <select
                  ...
                  defaultValue={initialData?.subscription_status || 'active'}
                  className="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary"
                >
              ...
              <div>
                ...
                <input
                  ...
                  defaultValue={initialData?.subscription_plan || ''}
                  className="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary"
              ...
              <div>
                ...
                <input
                  ...
                  name="max_users"
                  min="1"
                  defaultValue={initialData?.max_users || ''}
                  className="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary"
                  placeholder="e.g., 50"
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  name="max_residences"
                  min="1"
                  defaultValue={initialData?.max_residences || ''}
                  className="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary"
                  placeholder="e.g., 500"
                />
              </div>
